<?php
    ...
    class Data_Type_Collection_Floats 
        extends Data_Interface_Collection
    {
            ...
            if( is_array( $var ) ) {
                ...
                if( !empty( $var ) ) {
                    ...
                    foreach( $var as $value ) {
                        ...
                        if( !$value instanceof Data_Type_Float ) {
                            parent::_throwTypeException( "Item {$value} in {$var} is not an Data_Type_Float instance in " . __METHOD__ );
                        }
        ...
        {
            return ( $object instanceof self ) ? $object : new self( array( Data_Type_Float::valueOf( $object ) ) );
        }
